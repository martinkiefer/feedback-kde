...
echo "
	CREATE TABLE gen1_d3(
		...
		c2 double precision,
		c3 double precision);
	COPY INTO gen1_d3 FROM '/tmp/data_gen1_d3.csv' USING DELIMITERS ',','\r\n';
		CREATE TABLE gen1_d4(
		c1 double precision,
		c2 double precision,
		c3 double precision,
		c4 double precision);
	COPY INTO gen1_d4 FROM '/tmp/data_gen1_d4.csv' USING DELIMITERS ',','\r\n';
	CREATE TABLE gen1_d5(
		c1 double precision,
		c2 double precision,
		c3 double precision,
		c4 double precision,
		c5 double precision);
	COPY INTO gen1_d5 FROM '/tmp/data_gen1_d5.csv' USING DELIMITERS ',','\r\n';
	CREATE TABLE gen1_d8(
		c1 double precision,
		c2 double precision,
		c3 double precision,
		...
		c7 double precision,
		c8 double precision);
	COPY INTO gen1_d8 FROM '/tmp/data_gen1_d8.csv' USING DELIMITERS ',','\r\n';
	CREATE TABLE gen1_d10(
		c1 double precision,
		c2 double precision,
		c3 double precision,
		...
		c9 double precision,
		c10 double precision);
	COPY INTO gen1_d10 FROM '/tmp/data_gen1_d10.csv' USING DELIMITERS ',','\r\n';
