...
parser.add_argument("--dataset", action="store", choices=["set1", "set2", "forest", "tpch"], required=True, help="Which dataset should be run?")
...
queryfile = "%s_%i.sql" % (table, workload)
...
elif errortype == "relative":
    cur.execute("SET kde_error_metric TO Relative;")
